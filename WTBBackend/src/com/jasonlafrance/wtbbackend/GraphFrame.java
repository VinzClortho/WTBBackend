...
public class GraphFrame extends javax.swing.JFrame implements ComponentListener {
        ...
        while (li.hasNext()) {
            ...
            while (ti.hasNext()) {
                ...
                while (vi.hasNext()) {
                    ...
                    Node cur = new Node(v.get_shape_pt_lat(), v.get_shape_pt_lon());
                    if (last != null) {
                        // add edge
    ...
    public void adjustViewport(double xMin, double yMin, double xMax, double yMax) {
    ...
    private void initComponents() {
        ...
        ViewControlPanel.setMaximumSize(new java.awt.Dimension(200, 2147483647));
        ...
        getContentPane().add(ViewControlPanel, java.awt.BorderLayout.PAGE_START);
